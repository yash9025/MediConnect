    ...
    try {
      ...
      if (data.success) {
        ...
        updatedAppointments.sort((a, b) => {
          ...
          // We treat TODAY's appointments as "Upcoming" even if the hour has passed
          const isHistoryA = dateA < today; 
          const isHistoryB = dateB < today;

          // RULE 1: Separate History from Upcoming
          if (isHistoryA !== isHistoryB) {
            return isHistoryA ? 1 : -1; // History goes to bottom
          }
